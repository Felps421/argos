// E-mail de contato — um só lugar pra trocar quando tiver um de verdade.
export const CONTACT_EMAIL = 'contato@argos.dev';

// URLs de vídeo (CloudFront) — exatamente as que vieram no prompt.
export const VIDEOS = {
